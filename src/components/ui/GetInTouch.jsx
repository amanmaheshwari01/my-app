          ...
          <div className="bg-background rounded-2xl border border-border p-8 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="border border-border rounded-lg px-3 py-2 text-xs text-text-primary placeholder:text-text-primary bg-surface focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </div>
              <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                ...
                rows={4}
                className="border border-border rounded-lg px-3 py-2 text-xs text-text-primary placeholder:text-text-primary bg-surface focus:outline-none focus:ring-2 focus:ring-primary resize-none"
              />
            </div>
