      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:justify-between gap-8 py-10 lg:py-16">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-4 lg:gap-6 text-center lg:text-left items-center lg:items-start">
          ...
          <p className="text-base sm:text-lg text-saddle-brown leading-relaxed max-w-lg">
            ...
            <a href="#services"
            className="inline-flex items-center gap-2 bg-terracotta-accent text-warm-cream px-6 py-3 rounded-lg border-2 border-saddle-brown font-playfair font-semibold hover:bg-saddle-brown hover:text-warm-cream transition text-sm sm:text-base"
          >
